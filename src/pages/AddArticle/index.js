...
import { Row, Col, Input, Form, Select, Button, DatePicker, message } from 'antd';
import moment from 'moment';
import { addArticle, updateArticle, getArticleById } from '../../services/article';
import './styles.scss';
    ...
    >
      <Row gutter={5}>
        <Col span={18}>
          ...
          <Row gutter={10}>
            <Col span={12}>
              <Item name={'content'} rules={[{ required: true, message: 'Please input content!' }]}>
                <TextArea
            ...
            <Col span={12}>
              <div
                className="content-html markdown-body"
        ...
        <Col span={6}>
          ...
          <Row className="mb-4">
            <Col className="space-y-2" span={24}>
              ...
              >
                <TextArea rows={4} placeholder="introduction" onChange={changeIntroduction} />
              </Item>
              <div
                className="introduction-html markdown-body"
                dangerouslySetInnerHTML={{
          ...
          <Row>
            <Col span={15}>
              <Item name={'date'}>
                <DatePicker placeholder="select date" size="large" format={'YYYY-MM-DD'} />
              </Item>
            </Col>
          </Row>
        </Col>
